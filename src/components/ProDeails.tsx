    ...
    {productData &&     <div>
          <div className="flex flex-wrap mx-14 mr-20 lg:grid lg:grid-cols-2 lg:mx-0 xl:grid xl:grid-cols-2 2xl:grid 2xl:grid-cols-2">
            ...
            <div className="mx-5 sm:mx-20 md:mx-36 lg:mx-0 xl:mx-0 2xl:mx-0">
              ...
              <div className="flex">
              <Link href="/checkout">
                <button className="bg-black text-center text-white p-2 mt-4 w-64 hover:bg-white hover:text-black hover:border-black hover:border-2" onClick={handleAddToCart}>
                  Buy Now
                </button>
              </Link>
                <Link href="/compare">
