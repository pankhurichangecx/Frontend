...
const clearCreateProductForm = () => {
  ...
  const displayProductsForDelete = (products: any[]) => {
    ...
    if (productsGrid) {
      ...
      products.forEach((product) => {
        ...
        deleteButton.addEventListener('click', () => handleDeleteProduct(product._id));
  ...
  const displayProductsForUpdate = (products) => {
    ...
    if (productsGrid) {
      ...
      products.forEach((product) => {
        ...
        updateButton.className = 'bg-blue-500 text-white py-2 px-4 mt-2 rounded';
  ...
  const handleUpdateProductSubmit = async (e, productId) => {
    ...
    try {
      const response = await axios.patch(`http://127.0.0.1:3000/api/v1/products/${productId}`, updatedProductData);
  ...
  const handleDeleteProduct = async (productId) => {
    try {
      const response = await axios.delete(`http://127.0.0.1:3000/api/v1/products/${productId}`);
  ...
  return (
    <div className="lg:px-16 lg:py-2 px-6">
      <Navbar />
      <div className="lg:px-16 lg:py-2 px-6">
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-10 w-1/2 ml-80" onSubmit={handleActionSubmit}>
        ...
        >
          ...
          <div className="mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="issale">
              On Sale
            </label>
            <input
        ...
        <div>
  <div id="productsForDelete" className="grid grid-cols-3 gap-6 mt-4"></div>
</div>
...
>
  <div className="mb-4">
    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="updateName">
      Name
    </label>
    <input
      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
  ...
  <div className="mb-4">
    <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="updatePrice">
      Price
    </label>
    <input
      className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
